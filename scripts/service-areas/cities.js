...
module.exports = [
  {
    ...
    "contentImageAlt": "The Screen Team pool enclosure project in Tampa Bay",
    "contentImageCaption": "Tampa, FL \u2014 Tampa Bay Screen Team pool enclosure \u2014 regional client still, not a city skyline.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "brandon",
      "temple-terrace",
      "clearwater",
  ...
  },
  {
    ...
    "contentImageAlt": "Screen Team screened patio enclosure in the Tampa Bay service area",
    "contentImageCaption": "St. Petersburg, FL \u2014 Screen Team patio enclosure in the St. Petersburg service area \u2014 Tampa Bay client still.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "clearwater",
  ...
  },
  {
    ...
    "contentImageAlt": "Tampa Bay backyard pool and patio from a Screen Team project",
    "contentImageCaption": "Clearwater, FL \u2014 Screen Team Tampa Bay job still used on the Clearwater page \u2014 not beach stock.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "safety-harbor",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group handyman Vince Knight at a Safety Harbor client job",
    "contentImageCaption": "Safety Harbor, FL \u2014 Knight Group Safety Harbor HQ still \u2014 real Tampa Bay job photo, not stock waves.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "clearwater",
  ...
  },
  {
    ...
    "contentImageAlt": "Screen Team pool enclosure project in the Tampa Bay area",
    "contentImageCaption": "Palm Harbor, FL \u2014 Screen Team pool enclosure \u2014 Tampa Bay client still on the Palm Harbor page.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "tarpon-springs",
  ...
  },
  {
    ...
    "contentImageAlt": "Roof Monsters roofing job site in the Tampa Bay area",
    "contentImageCaption": "Dunedin, FL \u2014 Roof Monsters Dunedin-area job site \u2014 clean still, not a Manhattan skyline.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "palm-harbor",
  ...
  },
  {
    ...
    "contentImageAlt": "Screen Team lanai enclosure job in the Tampa Bay area",
    "contentImageCaption": "Largo, FL \u2014 Screen Team lanai enclosure \u2014 Tampa Bay client still on the Largo page.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "pinellas-park",
  ...
  },
  {
    ...
    "contentImageAlt": "Screen Team sunroom enclosure job in the Tampa Bay area",
    "contentImageCaption": "Pinellas Park, FL \u2014 Screen Team enclosure interior \u2014 Tampa Bay client still on the Pinellas Park page.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "largo",
  ...
  },
  {
    ...
    "contentImageAlt": "Screen Team window screen work in the Tampa Bay area",
    "contentImageCaption": "Seminole, FL \u2014 Screen Team window-screen job still on the Seminole page \u2014 not a Chicago lakefront.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "largo",
  ...
  },
  {
    ...
    "contentImageAlt": "Screen Team rescreen job in the Tampa Bay area",
    "contentImageCaption": "Tarpon Springs, FL \u2014 Screen Team rescreen job still on the Tarpon Springs page \u2014 not generic waves.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "palm-harbor",
  ...
  },
  {
    ...
    "contentImageAlt": "Tampa Bay residence from a Screen Team project folder",
    "contentImageCaption": "Oldsmar, FL \u2014 Screen Team project still on the Oldsmar page \u2014 not a New York skyline.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "safety-harbor",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group HVAC filter job still from a Tampa Bay client",
    "contentImageCaption": "Brandon, FL \u2014 Knight Group Tampa Bay job still on the Brandon page \u2014 not a Banff lake photo.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "riverview",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group carpenter on a Tampa Bay job site",
    "contentImageCaption": "Riverview, FL \u2014 Knight Group job-site still on the Riverview page \u2014 not a desert stock photo.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "brandon",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group handyman job still used on Tampa Bay city pages",
    "contentImageCaption": "Temple Terrace, FL \u2014 Knight Group Tampa Bay job still on the Temple Terrace page \u2014 not brick stock.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "tampa",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group handyman job still used on Tampa Bay city pages",
    "contentImageCaption": "Lutz, FL \u2014 Knight Group Tampa Bay job still on the Lutz page \u2014 not forest stock.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "land-o-lakes",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group carpenter on a Tampa Bay job site",
    "contentImageCaption": "Wesley Chapel, FL \u2014 Knight Group job-site still on the Wesley Chapel page \u2014 not a Manhattanhenge photo.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "land-o-lakes",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group carpenter on a Tampa Bay job site",
    "contentImageCaption": "New Port Richey, FL \u2014 Knight Group job-site still on the New Port Richey page \u2014 not the Golden Gate.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "holiday",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group handyman job still used on Tampa Bay city pages",
    "contentImageCaption": "Holiday, FL \u2014 Knight Group Tampa Bay job still on the Holiday page \u2014 not an alpine rowboat.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "new-port-richey",
  ...
  },
  {
    ...
    "contentImageAlt": "Knight Group carpenter on a Tampa Bay job site",
    "contentImageCaption": "Land O' Lakes, FL \u2014 Knight Group job-site still on the Land O' Lakes page \u2014 not dock stock.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "wesley-chapel",
  ...
  },
  {
    ...
    "contentImageAlt": "Faith Works land-clearing tractor on a Tampa Bay job site",
    "contentImageCaption": "Plant City, FL \u2014 Faith Works equipment still on the Plant City page \u2014 not soil stock.",
    "imageVerified": true,
    "imageQuery": "owned-tampa-bay-client-still",
    "siblings": [
      "brandon",
